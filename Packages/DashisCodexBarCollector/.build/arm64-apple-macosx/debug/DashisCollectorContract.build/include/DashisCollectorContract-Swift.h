...
#ifndef DASHISCOLLECTORCONTRACT_SWIFT_H
#define DASHISCOLLECTORCONTRACT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DashisCollectorContract",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP23DashisCollectorContract36DashisCollectorHostBrokerXPCProtocol_")
@protocol DashisCollectorHostBrokerXPCProtocol
- (void)resolve:(NSData * _Nonnull)requestData withReply:(void (^ _Nonnull)(NSData * _Nullable, NSError * _Nullable))reply;
@end

SWIFT_PROTOCOL("_TtP23DashisCollectorContract26DashisCollectorXPCProtocol_")
@protocol DashisCollectorXPCProtocol
- (void)send:(NSData * _Nonnull)requestData withReply:(void (^ _Nonnull)(NSData * _Nullable, NSError * _Nullable))reply;
@end
